    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChanged ={viewModel.onEvent(NutrientGoalEvent.OnCarbsRatioEnter(it))},
                unit = stringResource(id = R.string.percent_carbs)
            )
            Spacer(modifier = Modifier.width(spacing.spaceMedium))
            UnitTextField(
                value = viewModel.state.proteiinRatio,
            ...
            UnitTextField(
                ...
                onValueChanged ={viewModel.onEvent(NutrientGoalEvent.OnFatsRatioEnter(it))},
